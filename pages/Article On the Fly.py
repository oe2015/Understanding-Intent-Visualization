...
if text:
    ...
    response = requests.post("https://af14-196-129-11-16.ngrok-free.app/task1", json={"text": text})
    ...
    response = requests.post("https://af14-196-129-11-16.ngrok-free.app/task2", json={"text": text})
    # Get the prediction from the response
    ...
    response = requests.post("https://af14-196-129-11-16.ngrok-free.app/task3", json={"text": text})
    # Get the prediction from the response
