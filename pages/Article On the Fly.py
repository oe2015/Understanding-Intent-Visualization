...
if text:
    ...
    response = requests.post("https://1b73-94-200-14-123.ngrok-free.app/task1", json={"text": text})
    ...
    response = requests.post("https://1b73-94-200-14-123.ngrok-free.app/task2", json={"text": text})
    # Get the prediction from the response
    ...
    response = requests.post("https://1b73-94-200-14-123.ngrok-free.app/task3", json={"text": text})
    # Get the prediction from the response
