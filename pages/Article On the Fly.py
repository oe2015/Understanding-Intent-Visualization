...
if text:
    ...
    response = requests.post("https://9589-91-230-41-207.ngrok-free.app/task1", json={"text": text})
    ...
    response = requests.post("https://9589-91-230-41-207.ngrok-free.app/task2", json={"text": text})
    # Get the prediction from the response
    ...
    response = requests.post("https://9589-91-230-41-207.ngrok-free.app/task3", json={"text": text})
    # Get the prediction from the response
