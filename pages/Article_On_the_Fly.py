...
if text:
    ...
    response = requests.post("10.127.82.221:80/task1", json={"text": text})
    ...
    response = requests.post("10.127.82.221:80/task2", json={"text": text})
    # Get the prediction from the response
    ...
    response = requests.post("10.127.82.221:80/task3", json={"text": text})
    # Get the prediction from the response
