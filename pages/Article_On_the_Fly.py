...
if text:
    ...
    response = requests.post("https://7305-5-195-0-145.ngrok-free.app/task1", json={"text": text})
    ...
    response = requests.post("https://7305-5-195-0-145.ngrok-free.app/task2", json={"text": text})
    # Get the prediction from the response
    ...
    response = requests.post("https://7305-5-195-0-145.ngrok-free.app/task3", json={"text": text})
    # Get the prediction from the response
